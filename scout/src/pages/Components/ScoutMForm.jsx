    ...
    <div className="w-[40vw] bg-[#ffffff] flex flex-col text-[#000000] p-6 mt-5 mb-5 rounded-[20px] border-2 border-[#E7E7E9]">
      ...
      <div className="mb-4">
        ...
        <div className="w-full  flex flex-row justify-between gap-2 hover:cursor-pointer">
          <button className="py-2 w-[33.33%] bg-[#ffffff] flex justify-center rounded-lg hover:bg-[#F1F5F9]">
            Esquerda
          </button>
          <button className="py-2 w-[33.33%] bg-[#ffffff] flex justify-center rounded-lg hover:bg-[#F1F5F9]">
            Centro
      ...
      <div className="mb-4 flex flex-row justify-between gap-5">
        <div className="w-[50%]">
          ...
          <div className="w-full flex flex-row gap-5">
            <button className="text-xl w-15 h-15 cursor-pointer border-2 border-[#E7E7E9] rounded-lg hover:bg-[#F1F5F9] font-bold">
              -
            </button>
            <h1 className="text-6xl flex justify-center items-center">0</h1>
            <button className="text-3xl w-15 h-15 cursor-pointer border-2 border-[#E7E7E9] rounded-lg hover:bg-[#F1F5F9] font-bold">
              +
            </button>
          </div>
        </div>
      ...
      <div className="mb-4">
        ...
        <div className="w-[65%]  flex flex-row justify-between gap-2 hover:cursor-pointer">
          <button className="py-2 w-[25%] bg-[#ffffff] flex justify-center rounded-lg hover:bg-[#F1F5F9]">
            Nenhum
          </button>
          <button className="py-2 w-[25%] bg-[#ffffff] flex justify-center rounded-lg hover:bg-[#F1F5F9]">
            Nivel 1
      ...
      {/* Save data */}
      <button className="w-full flex justify-center bg-[#0F172A] text-white rounded-lg py-2 cursor-pointer hover:bg-[#141e37] transition-all duration-200">
        Salvar
      </button>
    </div>
  );
