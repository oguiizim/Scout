...
public class ScoutMatchController {
    ...
    // READ ALL FROM LOGGED USER
    @GetMapping("/me")
    public ResponseEntity<List<ScoutMatch>> findMyMatches() {
        List<ScoutMatch> obj = this.scoutMatchService.findAllFromLoggedUser();
        return ResponseEntity.ok().body(obj);
    }
