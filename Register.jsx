  ...
  return (
    <div className="font-nunito w-full min-h-screen flex items-center justify-center bg-[#ffffff]">
      <form
        ...
        className="text-black w-[30vw] min-w-[320px] max-w-[460px] flex flex-col items-center rounded-[20px] p-10 border-2 border-[#F1F5F9]"
      >
        <h1 className="text-2xl font-bold mb-2">Criar Conta</h1>
        <p className="text-[#262626] mb-6">
          Cadastro no sistema FRC Scout
        </p>
        ...
        <button
          type="submit"
          className="w-full bg-[#0F172A] py-2 rounded-lg text-white hover:bg-[#141e37]"
        >
          Criar Conta
        </button>
